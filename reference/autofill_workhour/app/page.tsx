        ...
        try {
          ...
          if (jsonData.随机时段工作内容) {
            const randomItems = jsonData.随机时段工作内容.map((item: any) => ({
              ...
              workType: item.工作类别 || '',
              contentType: item.关联项目 || item.内容属性 || '',
              workForm: item.工作形式 || '',
              remarks: item.备注 || '',
          ...
          if (jsonData.周末讲堂模板) {
            setWeekendLectureTemplate({
              ...
              contentType: jsonData.周末讲堂模板.关联项目 || jsonData.周末讲堂模板.内容属性 || '备注',
  ...
  const exportConfig = () => {
    const configData = {
      ...
      周末讲堂模板: {
        ...
        关联项目: weekendLectureTemplate.contentType,
                    ...
                    {showNewItemForm && (
                      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-2xl border-2 border-dashed border-blue-200">
                        <div className="grid grid-cols-3 gap-6 mb-4">
                          ...
                          <div>
                            <label className="block text-[12px] font-medium text-gray-700 mb-2">关联项目</label>
                            <Input
